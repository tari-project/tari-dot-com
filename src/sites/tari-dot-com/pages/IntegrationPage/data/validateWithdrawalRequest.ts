export const validateWithdrawalRequest = [
    {
        label: 'Pseudocode',
        content: `FUNCTION validateWithdrawalRequest(userId, destinationAddress, amount):
    ...
    {
        label: 'grpcurl',
        content: `# Step 1: Check wallet balance before withdrawal
...
if [ $? -eq 0 ]; then
    ...
    {
        label: 'Node.js',
        content: `class TariWithdrawalManager {
