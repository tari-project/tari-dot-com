export const generateDepositAddress = [
    {
        label: 'Pseudocode',
        content: `FUNCTION generateDepositAddress(userId):
    ...
    {
        label: 'grpcurl',
        content: `# First, get the exchange's main address (without payment ID)
...
class TariDepositManager:
    ...
    {
        label: 'Rust',
        content: `use tonic::transport::Channel;
...
pub struct DepositInfo {
    ...
    {
        label: 'PHP',
        content: `client = new WalletClient('localhost:18143', [
