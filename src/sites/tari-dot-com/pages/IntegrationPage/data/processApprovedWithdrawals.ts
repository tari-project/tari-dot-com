export const processApprovedWithdrawals = [
    {
        label: 'Pseudocode',
        content: `FUNCTION processApprovedWithdrawal(withdrawalRecord):
    ...
    {
        label: 'grpcurl',
        content: `# Complete withdrawal processing script
#!/bin/bash
...
echo "grpcurl -plaintext $AUTH_HEADER -d '{\"transaction_ids\": [$TRANSACTION_ID]}' $WALLET_HOST tari.rpc.Wallet/GetTransactionInfo"`,
    ...
    {
        label: 'Node.js',
        content: `class TariWithdrawalProcessor {
...
pub struct WithdrawalResult {
    ...
    {
        label: 'PHP',
        content: `walletClient = $walletClient;
        $this->metadata = $metadata;
    }
