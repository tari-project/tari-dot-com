export const incomingTransactions = [
    {
        label: 'Pseudocode',
        content: `FUNCTION monitorIncomingTransactions():
...
FUNCTION processTransaction(transaction):
    ...
    {
        label: 'grpcurl',
        content: `# Method 1: Stream all completed transactions
...
while read -r line; do
    ...
    {
        label: 'Node.js',
        content: `class TariDepositMonitor {
...
struct DepositRecord {
    ...
    {
        label: 'PHP',
        content: `depositManager = $depositManager;
    }
