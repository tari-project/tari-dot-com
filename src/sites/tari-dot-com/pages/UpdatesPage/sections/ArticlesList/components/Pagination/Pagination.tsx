...
export default function Pagination({ currentPage, totalPages }: Props) {
    ...
    return (
        <Wrapper>
            {currentPage > 1 && <PageButton href={`/updates?page=${currentPage - 1}`}>Previous</PageButton>}
            ...
            {currentPage < totalPages && <PageButton href={`/updates?page=${currentPage + 1}`}>Next</PageButton>}
        </Wrapper>
    );
}
