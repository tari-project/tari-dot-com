...
To help us better reflect on the changes and networks, we have changed how we represent the networks. Versions with a suffix of `rc` is nextnet, and versions with a suffix of `pre` is testnet, this is still currently Esmeralda. Since the last blog post about [networks](2023-02-17-update-100.md), we have written a detailed guide to what each number means and this can be read on the [github repository](https://github.com/tari-project/tari/blob/development/docs/src/branching_releases.md)
...
And finally, here is the complete list of features and fixes we've made from version 0.46.0 to 0.50.0-pre.0 
## [0.50.0-pre.0](https://github.com/tari-project/tari/compare/v0.49.0-pre.0...v0.50.0-pre.0) (2023-03-15)
