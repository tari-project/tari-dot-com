...
We’ve limited access to the app to test it out and get feedback. If you’re interested in participating, you can join the waiting list for early access on the [Tari Universe launch site](https://universe.tari.com/). In doing so, you have the opportunity to earn airdrop gems that - depending on how many you collect - will adjust the airdrop amount your receive when Tari launches. There are various ways to earn gems; you can learn more over at the [Airdrop Game page](https://airdrop.tari.com/).

We’d like to thank the community - veterans and newcomers alike - currently exploring the Universe and providing valuable suggestions and criticisms. Thanks to your support, we’ve already incorporated some key useability features and improved the overall experience.

### Making Tari Universe More Accessible
One of the key elements we want to tackle is language accessibility. Tari Universe handles this through JSON localization files, which makes it easy for anyone to add new or review existing localizations to the project. We've put together a guide for interested readers, which you find here.
