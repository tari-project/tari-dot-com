...
We’ve limited access to the app to test it in a controlled manner and get relevant feedback. If you’re interested in participating, you can join the waiting list for early access on the [Tari Universe launch site](https://universe.tari.com/). By joining us on this journey, you'll have the opportunity to earn airdrop gems that will positively impact the airdrop amount you receive when Tari launches. There are various ways to earn gems; you can learn more about them at the [Tari Airdrop Game website](https://airdrop.tari.com/).
