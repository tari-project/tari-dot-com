...
I this post, I'll explain what git commit farming is, and how it will help you get your PRs merged into Tari faster, 
and with less fuss.
...
3. The last commit is a merge-commit, where changes from the `testnet-dibbler` branch were pull into `development`.
