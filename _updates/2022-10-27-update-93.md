...
The first test shows the effect when any new base node starting up tries to sync from two pears. We can see that it 
...
The second test shows the effect when any new base node starting up tries to sync from five pears. Note that by changing
