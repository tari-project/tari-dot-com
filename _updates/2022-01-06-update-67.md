...
In the last post, we shared some highlights of 2021. In this post, I'll briefly share what the Tari core developers
...
* Buy a Yat from the Aurora UI.
* Send tXTR to Yats.

Soon, you'll be able to optionally share your Yat in transaction metadata so that recipients can add your Yat to their contact
list.
