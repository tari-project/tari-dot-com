...
Officially according to Ledger [documentation](https://developers.ledger.com/docs/embedded-app/introduction/) if you want to write an embedded [BOLOS](https://developers.ledger.com/docs/embedded-app/bolos-introduction/) application you have to write C code and only Linux as an OS is supported for the development environment. Although Windows gets unofficial support through its own [WSL](https://learn.microsoft.com/en-us/windows/wsl/install) program which runs a very light Linux VM inside of windows, MacOS support is completely lacking. 
...
To start us off, Ledger has started a process of providing a [Rust SDK](https://github.com/LedgerHQ/ledger-nanos-sdk/) proving access to underlying access to secure chip running inside of BOLOS as well as communication out to some external applications. 
