...
A new version of the Tari applications has been released. The release notes are provided at the end of this post, but the most interesting 
changes are related to the hard fork test.


### Testnet Hard Fork at 23000

We'll be testing a hard fork on Dibbler testnet at block 23000. That'ss likely to happen in the next 2 to 3 days, and you'll want to make sure you are running version 0.30.0 or higher of your 
base node before then. With previous network breaking changes it was easier and more efficient 
