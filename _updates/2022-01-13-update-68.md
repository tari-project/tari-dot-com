...
not final and are subject to change dramatic and without notice. 
...
the creator of a UTXO to dictate the rules about *how* it is spent. One main use case is to ensure that UTXO's that represent
