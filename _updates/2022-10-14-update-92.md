...
In this post, I'm going to expand on some of those thoughts.

## Proof-of-work first

There is a deep-seated conviction within the Tari development community that proof-of-work is 
the best way we know of to secure decentralised permissionless money. My scepticism of proof-of-stake 
...
the network are made with 100% finality and there is no need for proof-of-anything.
...
* Using the base layer as a registrar, we have a very convenient Sybil resistance and registration mechanism.

As a near-immutable means of record, the base layer will also be used for managing contract templates and version 
control for the DAN contracts. But that's a post for another time.
