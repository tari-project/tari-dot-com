...
P2Pool is an immensely popular feature, but as it stands, the public pool's needed a little chlorine over the past two weeks to get it in order. Community contributors have been at work measuring pH levels, balancing chemicals and even finding some to throw in some pool tubes and wave machines for your enjoyment.

Metaphor aside, P2Pool has been a core focus for the community, with several bug fixes, feature improvements and enhancments to the overall process:
