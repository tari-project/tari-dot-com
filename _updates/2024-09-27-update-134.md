...
It's been a while since our last Developer Update, and you might be wondering where we've been. Oh, just birthing a universe - and that takes time! But we've now ignited the fuse on that Big Bang, now rapidly expanding.
...
* Incorporating community favorite features, such as integrated, simple P2Pool functionality (which we discussed [in our previous update](https://tari.com/updates/2024-07-22-update-133), which delivers smaller but more consistent mining rewards) and merge mining while making it incredibly simple to run for the average user.
