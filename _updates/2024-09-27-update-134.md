...
What are we talking about? Buckle up, because this update is a big one. Alongside your regular assortment of fixes, improvements, and new features, we have some exciting news to share.
...
* Multiple improvements to the user interface, whether that’s giving users the option to control their rate of mining, change their localization (currently English, Afrikaans, Turkish or Polish; we’ll be covering how you can add your own localizations in the next update) or provide stats on other related Tari services and applications (such as referrals and gems from [the Tari Airdrop Game](https://airdrop.tari.com).
