/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.env.typegen --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4591fcc7356aa3b26d97125b542ec34c)
